export const projects = [
  {
    ...
    category: 'Agentic AI',
    demoVideo: '/projects/football-scouting-agent-demo.mp4',
    status: 'live',
  ...
  },
  {
    ...
    modalImages: [
      '/projects/aita-classifier-header.webp',
      '/projects/aita-classifier-error-landscape.webp',
    ],
    status: 'live',
  ...
  },
  {
    ...
    modalImages: ['/projects/goodreads-recommender-demo.webp'],
    status: 'live',
